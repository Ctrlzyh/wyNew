...
- (void)buildUI {
    ...
    self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(kScreenW/3, self.bounds.size.height - controlHeight, self.bounds.size.width, controlHeight)];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.headline = self.titles[indexPath.row];
    return cell;
}
